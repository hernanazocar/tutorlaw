...
export function FlashcardGenerator({ isOpen, onClose, jurisdiccion }: FlashcardGeneratorProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[95vh] sm:max-h-[85vh] overflow-hidden flex flex-col">
        {/* Header */}
          ...
          <div className="flex justify-between items-start">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <h2 className="text-lg font-bold">Flashcards Auto-generadas</h2>
              </div>
              <p className="text-indigo-100 text-xs">Crea tarjetas de estudio con IA</p>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Contratos, Delitos contra la propiedad..."
