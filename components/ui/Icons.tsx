...
export const ScaleIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="M5 7h14l-2 7H7L5 7z" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M19 7l-2 7" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const FlameIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M8.5 14.6a6.5 6.5 0 0 0 2.78 5.34c.41.28.96.33 1.42.09.96-.5 3.8-2.3 3.8-7.03 0-2.5-1.5-4.5-3.5-5.5.5 2-2 4-3.5 4-1 0-2-.5-2.5-1.5-.5 1.5 0 3.1 1.5 4.6z"/>
    <path d="M12 2C8 2 5 8 5 14c0 2.21.91 4.2 2.5 5.5.28-1.8 1.5-3.3 3-4 0 1.5.5 2.5 1.5 3.5 1-1 1.5-2 1.5-3.5 1.5.7 2.72 2.2 3 4 1.59-1.3 2.5-3.29 2.5-5.5 0-6-3-12-7-12z"/>
  </svg>
);
...
export const SettingsIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="m4.22 4.22 4.24 4.24m5.08 5.08 4.24 4.24" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="m19.78 4.22-4.24 4.24m-5.08 5.08-4.24 4.24" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const SparklesIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M9.5 2l1.5 4.5L15.5 8l-4.5 1.5L9.5 14 8 9.5 3.5 8 8 6.5 9.5 2z"/>
    <path d="M18 14l0.75 2.25L21 17l-2.25 0.75L18 20l-0.75-2.25L15 17l2.25-0.75L18 14z"/>
  </svg>
);
...
export const AcademicCapIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="M12 14l9-5v7.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
