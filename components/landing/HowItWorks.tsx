            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 h-full">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="relative">
                  <div className="w-16 h-16 rounded-xl bg-white/20 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-white text-[#0066ff] flex items-center justify-center text-xs font-bold shadow-lg">
                    1
                  </div>
                </div>
