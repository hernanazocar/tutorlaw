  ...
  return (
    <div className="bg-gradient-to-b from-white to-[#f8f9fa] py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Testimonial inline */}
        <div className="mt-20 max-w-3xl mx-auto bg-[#f8f9fa] rounded-2xl p-8 border border-[#e9ecef]">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#0066ff] to-[#0052cc] flex items-center justify-center text-white font-bold flex-shrink-0">
              M
            </div>
            <div>
              <p className="font-sans text-[#212529] leading-relaxed mb-3">
              ...
              <div className="flex items-center gap-2">
                <span className="font-sans font-semibold text-sm text-[#212529]">María José</span>
                <span className="text-[#6c757d] text-sm">·</span>
                <span className="font-sans text-sm text-[#6c757d]">3° año Derecho UC</span>
              </div>
            </div>
          </div>
        </div>
